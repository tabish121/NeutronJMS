...
import io.neutronjms.openwire.commands.MessageAck;
...
public class MessageAckMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        info.setConsumerId((io.neutronjms.openwire.commands.ConsumerId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setAckType(dataIn.readByte());
        info.setFirstMessageId((io.neutronjms.openwire.commands.MessageId) tightUnmarsalNestedObject(wireFormat, dataIn, bs));
        info.setLastMessageId((io.neutronjms.openwire.commands.MessageId) tightUnmarsalNestedObject(wireFormat, dataIn, bs));
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn) throws IOException {
        ...
        info.setConsumerId((io.neutronjms.openwire.commands.ConsumerId) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setAckType(dataIn.readByte());
        info.setFirstMessageId((io.neutronjms.openwire.commands.MessageId) looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setLastMessageId((io.neutronjms.openwire.commands.MessageId) looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setMessageCount(dataIn.readInt());
    }
