...
import io.neutronjms.openwire.commands.Message;
...
public abstract class MessageMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        info.setProducerId((io.neutronjms.openwire.commands.ProducerId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setDestination((OpenWireDestination) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setTransactionId((io.neutronjms.openwire.commands.TransactionId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setOriginalDestination((OpenWireDestination) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setMessageId((io.neutronjms.openwire.commands.MessageId) tightUnmarsalNestedObject(wireFormat, dataIn, bs));
        info.setOriginalTransactionId((io.neutronjms.openwire.commands.TransactionId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        ...
        info.setTargetConsumerId((io.neutronjms.openwire.commands.ConsumerId) tightUnmarsalCachedObject(wireFormat, dataIn, bs));
        info.setCompressed(bs.readBoolean());
        info.setRedeliveryCounter(dataIn.readInt());

        if (bs.readBoolean()) {
            short size = dataIn.readShort();
            io.neutronjms.openwire.commands.BrokerId value[] = new io.neutronjms.openwire.commands.BrokerId[size];
            for (int i = 0; i < size; i++) {
                value[i] = (io.neutronjms.openwire.commands.BrokerId) tightUnmarsalNestedObject(wireFormat, dataIn, bs);
            }
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn) throws IOException {
        ...
        info.setProducerId((io.neutronjms.openwire.commands.ProducerId) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setDestination((OpenWireDestination) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setTransactionId((io.neutronjms.openwire.commands.TransactionId) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setOriginalDestination((OpenWireDestination) looseUnmarsalCachedObject(wireFormat, dataIn));
        info.setMessageId((io.neutronjms.openwire.commands.MessageId) looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setOriginalTransactionId((io.neutronjms.openwire.commands.TransactionId) looseUnmarsalCachedObject(wireFormat, dataIn));
        ...
        info.setTargetConsumerId((io.neutronjms.openwire.commands.ConsumerId) looseUnmarsalCachedObject(wireFormat, dataIn));
        ...
        if (dataIn.readBoolean()) {
            ...
            io.neutronjms.openwire.commands.BrokerId value[] = new io.neutronjms.openwire.commands.BrokerId[size];
            for (int i = 0; i < size; i++) {
                value[i] = (io.neutronjms.openwire.commands.BrokerId) looseUnmarsalNestedObject(wireFormat, dataIn);
            }
            info.setBrokerPath(value);
        } else {
            info.setBrokerPath(null);
