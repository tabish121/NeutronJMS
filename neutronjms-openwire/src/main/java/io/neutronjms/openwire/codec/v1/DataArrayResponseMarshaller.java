...
import io.neutronjms.openwire.commands.DataArrayResponse;
...
public class DataArrayResponseMarshaller extends ResponseMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        if (bs.readBoolean()) {
            ...
            io.neutronjms.openwire.commands.DataStructure value[] = new io.neutronjms.openwire.commands.DataStructure[size];
