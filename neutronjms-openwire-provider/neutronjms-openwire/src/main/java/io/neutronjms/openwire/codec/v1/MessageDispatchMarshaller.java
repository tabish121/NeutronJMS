...
import io.neutronjms.openwire.commands.MessageDispatch;
...
public class MessageDispatchMarshaller extends BaseCommandMarshaller {
    ...
    public void tightUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn, BooleanStream bs) throws IOException {
        ...
        info.setMessage((io.neutronjms.openwire.commands.Message) tightUnmarsalNestedObject(wireFormat, dataIn, bs));
    ...
    public void looseUnmarshal(OpenWireFormat wireFormat, Object o, DataInput dataIn) throws IOException {
        ...
        info.setMessage((io.neutronjms.openwire.commands.Message) looseUnmarsalNestedObject(wireFormat, dataIn));
        info.setRedeliveryCounter(dataIn.readInt());
    }
