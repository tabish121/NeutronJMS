...
import static io.neutronjms.provider.stomp.StompConstants.COLON_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.COLON_ESCAPE_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.COLON_ESCAPE_SEQ;
import static io.neutronjms.provider.stomp.StompConstants.ESCAPE_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.ESCAPE_ESCAPE_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.ESCAPE_ESCAPE_SEQ;
import static io.neutronjms.provider.stomp.StompConstants.NEWLINE_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.NEWLINE_ESCAPE_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.NEWLINE_ESCAPE_SEQ;
import static io.neutronjms.provider.stomp.StompConstants.NULL_BYTE;
import static io.neutronjms.provider.stomp.StompConstants.UTF8;
import static io.neutronjms.provider.stomp.StompConstants.V1_0;
