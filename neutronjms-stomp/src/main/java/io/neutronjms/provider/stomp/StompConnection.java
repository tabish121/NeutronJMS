...
import static io.neutronjms.provider.stomp.StompConstants.ACCEPT_VERSION;
import static io.neutronjms.provider.stomp.StompConstants.CLIENT_ID;
import static io.neutronjms.provider.stomp.StompConstants.CONNECTED;
import static io.neutronjms.provider.stomp.StompConstants.ERROR;
import static io.neutronjms.provider.stomp.StompConstants.HEARTBEAT;
import static io.neutronjms.provider.stomp.StompConstants.HOST;
import static io.neutronjms.provider.stomp.StompConstants.INVALID_CLIENTID_EXCEPTION;
import static io.neutronjms.provider.stomp.StompConstants.INVALID_SELECTOR_EXCEPTION;
import static io.neutronjms.provider.stomp.StompConstants.JMS_SECURITY_EXCEPTION;
import static io.neutronjms.provider.stomp.StompConstants.LOGIN;
import static io.neutronjms.provider.stomp.StompConstants.MESSAGE;
import static io.neutronjms.provider.stomp.StompConstants.PASSCODE;
import static io.neutronjms.provider.stomp.StompConstants.RECEIPT;
import static io.neutronjms.provider.stomp.StompConstants.RECEIPT_ID;
import static io.neutronjms.provider.stomp.StompConstants.RECEIPT_REQUESTED;
import static io.neutronjms.provider.stomp.StompConstants.SECURITY_EXCEPTION;
import static io.neutronjms.provider.stomp.StompConstants.SERVER;
import static io.neutronjms.provider.stomp.StompConstants.SESSION;
import static io.neutronjms.provider.stomp.StompConstants.STOMP;
import static io.neutronjms.provider.stomp.StompConstants.SUBSCRIPTION;
import static io.neutronjms.provider.stomp.StompConstants.VERSION;
...
import io.neutronjms.provider.stomp.adapters.StompServerAdapterFactory;
