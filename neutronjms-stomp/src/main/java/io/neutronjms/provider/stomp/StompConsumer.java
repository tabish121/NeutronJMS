...
import static io.neutronjms.provider.stomp.StompConstants.ACK;
import static io.neutronjms.provider.stomp.StompConstants.ACK_ID;
import static io.neutronjms.provider.stomp.StompConstants.ACK_MODE;
import static io.neutronjms.provider.stomp.StompConstants.DESTINATION;
import static io.neutronjms.provider.stomp.StompConstants.ID;
import static io.neutronjms.provider.stomp.StompConstants.MESSAGE_ID;
import static io.neutronjms.provider.stomp.StompConstants.SELECTOR;
import static io.neutronjms.provider.stomp.StompConstants.SUBSCRIBE;
import static io.neutronjms.provider.stomp.StompConstants.SUBSCRIPTION;
import static io.neutronjms.provider.stomp.StompConstants.UNSUBSCRIBE;
