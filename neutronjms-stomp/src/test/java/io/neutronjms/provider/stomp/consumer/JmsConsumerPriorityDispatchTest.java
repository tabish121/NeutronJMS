 ...
 */
package io.neutronjms.provider.stomp.consumer;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNotNull;
import io.neutronjms.jms.JmsConnection;
import io.neutronjms.test.support.StompTestSupport;
 ...
 */
public class JmsConsumerPriorityDispatchTest extends StompTestSupport {
    ...
    public void testPrefetchedMessageAreNotPriorityOrdered() throws Exception {
        ...
        // broker method in StompTestSupport.  If that changes then this test will sometimes
        // fail.
